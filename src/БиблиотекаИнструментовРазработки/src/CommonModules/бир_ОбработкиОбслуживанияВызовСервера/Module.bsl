...
Функция ПолучитьСписокОбработокОбслуживания(ПрефиксОбработки = Неопределено
	...
	Возврат	бир_ОбработкиОбслуживания.ПолучитьСписокОбработокОбслуживания(ПрефиксОбработки
...
Функция ЭтоОбработкаОбслуживания(АдресОбработки, ИмяКонтрольнойПроцедуры = Неопределено, ПараметрыКонтрольнойПроцедуры = Неопределено) Экспорт
	...
	Возврат бир_ОбработкиОбслуживания.ЭтоОбработкаОбслуживания(АдресОбработки, ИмяКонтрольнойПроцедуры, ПараметрыКонтрольнойПроцедуры);
...
Функция ПолучитьОписаниеОбработкиОбслуживания(АдресОбработки, ИмяОбработки = "") Экспорт
	...
	Возврат бир_ОбработкиОбслуживания.ПолучитьОписаниеОбработкиОбслуживания(АдресОбработки, ИмяОбработки, Ложь);
