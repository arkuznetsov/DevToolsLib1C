...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	бир_ОбработкиОбслуживания.ОбъектПриСозданииНаСервере(Отказ
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	бир_ОбработкиОбслуживания.ОбъектПередЗаписьюНаСервере(Отказ
														, ТекущийОбъект
														, ПараметрыЗаписи
														, ЭтаФорма
														, ОбработкаПараметры.ПутьКДаннымОбработка
...
Процедура ОбработкаОбслуживанияНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	бир_ОбработкиОбслуживанияКлиент.ОбработкаОбслуживанияНачалоВыбора(Элемент
																	, ДанныеВыбора
																	, СтандартнаяОбработка
																	, ЭтаФорма
																	, ОбработкаПараметры.ПутьКДаннымОбработкаАдресВХранилище
...
Процедура ОбработкаОбслуживанияОткрытие(Элемент, СтандартнаяОбработка)
	...
	бир_ОбработкиОбслуживанияКлиент.ОбработкаОбслуживанияОткрытие(Элемент
																, СтандартнаяОбработка
																, ЭтаФорма
																, ОбработкаПараметры.ПутьКДаннымОбработкаАдресВХранилище
																, ОбработкаПараметры.ПутьКДаннымОбработкаНастройкиАдресВХранилище);
...
Процедура ОбработкаОбслуживанияОчистка(Элемент, СтандартнаяОбработка)
	...
	бир_ОбработкиОбслуживанияКлиент.ОбработкаОбслуживанияОчистка(Элемент
															   , СтандартнаяОбработка
															   , ЭтаФорма
															   , ОбработкаПараметры.ПутьКДаннымОбработкаАдресВХранилище
															   , ОбработкаПараметры.ПутьКДаннымОбработкаПредставление);
...
ОбработкаПараметры.Вставить("ПрефиксОбработки"								, "бир_СобытияОбработчик");
