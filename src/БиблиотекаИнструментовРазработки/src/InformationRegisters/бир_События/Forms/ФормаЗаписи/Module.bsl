...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Выборка.Следующий() Тогда
		...
		Попытка
			...
			ВремПараметры = ПреобразованиеДанных().ЗначениеИзСтруктуры(СтруктураПараметров, Истина, Ложь);
		Исключение
...
Процедура ПараметрыСобытияЗначениеОткрытие(Элемент, СтандартнаяОбработка)
	...
	Если ТипЗнч(ТекущиеДанные.Значение) = Тип("Структура")
	 ИЛИ ТипЗнч(ТекущиеДанные.Значение) = Тип("ФиксированнаяСтруктура") Тогда
		...
		ФормаПросмотра = ПолучитьФорму("РегистрСведений.бир_События.Форма.ФормаПросмотраСоответствия", Новый Структура("Соответствие", ВремЗначение), ЭтаФорма.УникальныйИдентификатор, Запись.Ид + "_" + ТекущиеДанные.Параметр);
